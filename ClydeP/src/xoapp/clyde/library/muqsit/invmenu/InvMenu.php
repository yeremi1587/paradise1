...
namespace xoapp\clyde\library\muqsit\invmenu;
...
use xoapp\clyde\library\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use xoapp\clyde\library\muqsit\invmenu\session\InvMenuInfo;
use xoapp\clyde\library\muqsit\invmenu\session\network\PlayerNetwork;
use xoapp\clyde\library\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
...
use xoapp\clyde\library\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
...
class InvMenu implements InvMenuTypeIds{
	 ...
	 * @return Closure(\xoapp\clyde\library\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult
	 */
	...
	/**
	 * @return \xoapp\clyde\library\muqsit\invmenu\type\InvMenuType
	...
	/**
	 * @return (Closure(\xoapp\clyde\library\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null
	 */
	...
	/**
	 * @param (Closure(\xoapp\clyde\library\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null $listener
	 * @return self
	 */
